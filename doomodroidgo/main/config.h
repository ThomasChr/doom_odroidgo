...
/* Name of package */
#define PACKAGE "chocolate-doom-odroidgo"
/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "thomaschristlieb@hotmail.com"
/* Define to the full name of this package. */
#define PACKAGE_NAME "Chocolate Doom Odroid Go"
/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Chocolate Doom 3.0.0"
/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "chocolate-doom-odroigdo"
